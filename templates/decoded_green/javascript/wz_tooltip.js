...
function tt_Htm(tt, t_id, txt)
{
	...
	t_alpha   = (typeof tt.T_ALPHA != tt_u)? tt.T_ALPHA  : ttAlpha; // (by pappkamerad)
	...
	// alpha (by pappkamerad)
		var t_opa_main = tt_n6? '-moz-opacity:0.' + t_alpha + ';' : tt_ie? 'filter:Alpha(opacity=' + t_alpha + ');' : '';
		t_y += t_opa_main + '">';
	// end of alpha
