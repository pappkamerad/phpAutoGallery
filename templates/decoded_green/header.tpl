...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{$vCSSPath}/style.css"/>
	<script src="{$vJavascriptPath}/functions.js" type="text/javascript"></script>
</head>

<body>

<script type="text/javascript">
	window.name = 'phpAutoGallery_main';
</script>
