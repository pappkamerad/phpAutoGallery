...
<tr>
	<td align="center">
		Indexed&nbsp;by&nbsp;<a href="http://www.decoded.net/" target="_blank">phpAutoGallery</a>&nbsp;v{$vVersion}<br>Copyright &copy; 2003&nbsp;<a href="mailto:pappkamerad@decoded.net">martin theimer</a>
	</td>
</tr>
</table>
